...
#' 
## ----ReadCovData, fig.width=8, message=FALSE-----------------------------
...
#' 
## ----MakeRegionPolygon, message=FALSE------------------------------------
...
#' 
## ----MakeCovariateSpDataFrame, fig.width=8, message=FALSE----------------
...
#' 
## ----ReadSpeciesData, message=FALSE, fig.width=6, fig.height=6-----------
data("SolTin_ebird")
...
#' 
## ----MakeMesh, message=FALSE, warning=FALSE, fig.width=5, fig.height=5----
...
#' 
## ----PlotModel, message=FALSE, fig.width=6, fig.height=6-----------------
...
#' 
## ----PlotModelNoSpat, message=FALSE, fig.width=6, fig.height=6-----------
...
#' 
## ----TryQuadraticSurface, message=FALSE----------------------------------
